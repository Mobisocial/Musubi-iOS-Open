...
- (void)request:(FBRequest *)request didLoad:(id)result {
    ...
    for (NSDictionary* f in result) {
        ...
        MIdentity* mId = [im ensureIdentityWithType:kIdentityTypeFacebook andPrincipal: [NSString stringWithFormat:@"%llu", uid] andName: [f objectForKey:@"name"] identityAdded:&_identityAdded profileDataChanged:&_profileDataChanged];
    ...
    if (account == nil) {
        ...
        MIdentity* existing = [im identityForType:kIdentityTypeFacebook andPrincipal:facebookId];
        if (existing != nil) {
