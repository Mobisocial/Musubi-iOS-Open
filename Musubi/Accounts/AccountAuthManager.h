...
@class MIdentity, MAccount, IdentityManager, IBEncryptionIdentity, AccountAuthManager;
...
@protocol AccountAuthOperation
- (id) initWithManager: (AccountAuthManager*) manager andPrincipal: (NSString*) principal;
@end

@interface AccountAuthConfiguration : NSObject

@property (nonatomic, assign) uint8_t authorityType;
@property (nonatomic, weak) Class checkValidOp;
@property (nonatomic, weak) Class loginOp;
@property (nonatomic, weak) Class logoutOp;
...
+ (AccountAuthConfiguration*) configurationForType: (NSString*) type;
+ (void) setConfiguration: (AccountAuthConfiguration*) config forType: (NSString*) type;
